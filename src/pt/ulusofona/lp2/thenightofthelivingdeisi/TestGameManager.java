...
public class TestGameManager {
    ...
    @Test public void testGameCreatureInfo() throws InvalidFileException, IOException {
        ...
        assertEquals("null", Arrays.toString(gameManager.getCreatureInfo(0)));
        assertEquals(null, gameManager.getCreatureInfoAsString(0));
        assertEquals(null, gameManager.getEquipmentInfoAsString(0));
        assertEquals("null", Arrays.toString(gameManager.getEquipmentInfo(0)));
